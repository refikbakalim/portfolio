...
const Skill = ({ name, x, y }: { name: string, x: string, y: string }) => {
	return (
		<motion.div className='flex ğtems-center justify-center rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark cursor-pointer absolute'
	...
	return (
		<>
			...
			<div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight'>
				<motion.div className='flex ğtems-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer' whileHover={{ scale: 1.05 }}>
					Skills
				</motion.div>
